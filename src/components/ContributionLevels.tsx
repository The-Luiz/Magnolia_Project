...
const levels = [
  ...
  },
  {
    ...
    icon: Ticket,
    color: "from-[#7FB3FF] to-[#A8CCFF]",
    iconBg: "bg-[#1E3A6F]/55 border border-[#7FB3FF]/35 text-[#A8CCFF] shadow-[0_0_30px_rgba(127,179,255,0.05)]",
    borderColor: "border-[#7FB3FF]/15 dark:border-[#7FB3FF]/20",
    hoverBorder: "hover:border-[#7FB3FF]/35",
  },
  {
    ...
    iconBg: "bg-[#F89C24]/10 border border-[#F89C24]/25 text-[#fbbf24]",
